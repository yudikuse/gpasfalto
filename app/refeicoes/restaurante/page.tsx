...
//     → guarda qual turno aguarda confirmação de cancelamento.
//
//  2. cancelShift() — agora tem dois estágios:
//     • Estágio 1 (pedido não confirmado): seta pendingCancelShift
//       e mostra o card "Tem certeza?" sem deletar nada.
//     • Estágio 2: handleConfirmCancel() executa o DELETE de fato.
//     • Pedido já confirmado continua bloqueado com mensagem de erro
//       (comportamento do Passo 1, mantido).
//
//  3. handleConfirmCancel()  ← NOVA
//     → chamada pelo botão "Sim, cancelar" do card de confirmação.
//
//  4. handleBottomCancel()
//     → agora chama requestCancel() em vez de cancelShift() diretamente,
//       para garantir que o dialog apareça independente do modo.
//
//  5. JSX — card de confirmação de cancelamento
//     → aparece na seção de controles, acima dos botões da barra fixa.
// ─────────────────────────────────────────────────────────────
